...
Exit.place(relx=0.25, rely=0.7, anchor="center")  # Centrar el botón en la mitad derecha
...
Draw.place(relx=0.5, rely=0.7, anchor="center")
...
Graph.place(relx=0.75, rely=0.7, anchor="center")

Clear = tk.Button(left_half, text="Clear", fg="#FFFFFF", command=Clean)
Clear.config(bg="#4a6c65", borderwidth=0, highlightthickness=0, relief="flat")
Clear.place(relx=0.25, rely=0.8, anchor="center")

Botton2 = tk.Button(left_half, text="Boton", fg="#FFFFFF")
Botton2.config(bg="#4a6c65", borderwidth=0, highlightthickness=0, relief="flat")
Botton2.place(relx=0.5, rely=0.8, anchor="center")

Botton3 = tk.Button(left_half, text="Boton", fg="#FFFFFF")
Botton3.config(bg="#4a6c65", borderwidth=0, highlightthickness=0, relief="flat")
Botton3.place(relx=0.75, rely=0.8, anchor="center")

text_label = tk.Label(left_half, text="", bg="#4a6c65", fg="white", width=30)
text_label.pack(expand=True)
text_label.place(relx=0.5, rely=0.5, anchor="center")

Entry = tk.Entry(left_half)
